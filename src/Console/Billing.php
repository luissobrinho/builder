...
class Billing extends LuissobrinhoCommand
{
    use FileMakerTrait;
     ...
     * @var string
     */
    protected $signature = 'luissobrinho:billing';
     ...
     * @var string
     */
    protected $description = 'Luissobrinho Builder will add billing to your app';
    ...
    public function handle()
    {
        if ($this->starterIsInstalled()) {
            ...
            if ($result) {
                ...
                $this->info('You cancelled the luissobrinho:billing');
            }
        }
    }
}
