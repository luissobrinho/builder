...
class Notifications extends LuissobrinhoCommand
{
    use FileMakerTrait;
     ...
     * @var string
     */
    protected $signature = 'luissobrinho:notifications';
     ...
     * @var string
     */
    protected $description = 'Luissobrinho Builder will add notifications to your app';
    ...
    public function handle()
    {
        if ($this->starterIsInstalled()) {
            ...
            if ($result) {
                ...
                $this->info("\n You cancelled the luissobrinho:notifications");
            }
        }
    }
}
