...
class Api extends LuissobrinhoCommand
{
    use FileMakerTrait;
     ...
     * @var string
     */
    protected $signature = 'luissobrinho:api';
     ...
     * @var string
     */
    protected $description = 'Luissobrinho Builder will add JWT API access to your app';
    ...
    public function handle()
    {
        if ($this->starterIsInstalled()) {
            ...
            if ($result) {
                ...
                $this->info('You cancelled the luissobrinho:api');
            }
        }
    }
}
