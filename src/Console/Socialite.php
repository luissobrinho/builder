...
class Socialite extends LuissobrinhoCommand
{
    use FileMakerTrait;
     ...
     * @var string
     */
    protected $signature = 'luissobrinho:socialite';
     ...
     * @var string
     */
    protected $description = 'Luissobrinho Builder will add a Socialite auth to your app';
    ...
    public function handle()
    {
        if ($this->starterIsInstalled()) {
            ...
            if ($result) {
                ...
                $this->info('You cancelled the luissobrinho:socialite');
            }
        }
    }
}
