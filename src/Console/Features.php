...
class Features extends LuissobrinhoCommand
{
    use FileMakerTrait;
     ...
     * @var string
     */
    protected $signature = 'luissobrinho:features';
     ...
     * @var string
     */
    protected $description = 'Luissobrinho Builder will add a feature management UI to your app';
    ...
    public function handle()
    {
        if ($this->starterIsInstalled()) {
            ...
            if ($result) {
                ...
                $this->info("\n You cancelled the luissobrinho:features");
            }
        }
    }
}
