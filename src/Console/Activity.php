...
class Activity extends LuissobrinhoCommand
{
    use FileMakerTrait;
     ...
     * @var string
     */
    protected $signature = 'luissobrinho:activity';
     ...
     * @var string
     */
    protected $description = 'Luissobrinho Builder will add an activity tracker for your users';
    ...
    public function handle()
    {
        if ($this->starterIsInstalled()) {
            ...
            if ($result) {
                ...
                $this->info("\n You cancelled the luissobrinho:activity");
            }
        }
    }
}
