...
class Forge extends LuissobrinhoCommand
{
    use FileMakerTrait;
     ...
     * @var string
     */
    protected $signature = 'luissobrinho:forge';
     ...
     * @var string
     */
    protected $description = 'Luissobrinho Builder will add a FORGE admin UI to your app';
    ...
    public function handle()
    {
        if ($this->starterIsInstalled()) {
            ...
            if ($result) {
                ...
                $this->info("\n You cancelled the luissobrinho:forge");
            }
        }
    }
}
