...
class Starter extends Command
{
     ...
     * @var string
     */
    protected $signature = 'luissobrinho:starter';
     ...
     * @var string
     */
    protected $description = 'Luissobrinho Builder will build some common parts of your app';
    ...
    public function handle()
    {
        ...
        if ($result) {
            ...
            $this->info('You cancelled the luissobrinho:starter');
        }
    }
