...
class Queue extends LuissobrinhoCommand
{
    use FileMakerTrait;
     ...
     * @var string
     */
    protected $signature = 'luissobrinho:queue';
     ...
     * @var string
     */
    protected $description = 'Luissobrinho Builder will add a database driven queue manager for your app';
    ...
    public function handle()
    {
        if ($this->starterIsInstalled()) {
            ...
            if ($result) {
                ...
                $this->info("\n You cancelled the luissobrinho:queue");
            }
        }
    }
}
